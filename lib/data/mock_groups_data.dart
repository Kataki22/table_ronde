  ...
  static List<GroupChatModel> _generateGroups() {
    return [
      ...
      GroupChatModel(
        ...
        photoUrl: 'assets/images/test.png', // Utilise une image disponible
        members: [
          GroupMemberModel(
            userId: 'user_1',
            name: 'AlistairJr',
            avatarUrl: AvatarHelper.getAvatarUrl('user_1'),
          ...
          GroupMemberModel(
            userId: 'user_2',
            name: 'T4zor',
            avatarUrl: AvatarHelper.getAvatarUrl('user_2'),
          ...
          GroupMemberModel(
            userId: 'user_3',
            name: 'Tk-Porky',
            avatarUrl: AvatarHelper.getAvatarUrl('user_3'),
          ...
          GroupMemberModel(
            userId: 'user_4',
            name: 'Sophie Martin',
            avatarUrl: AvatarHelper.getAvatarUrl('user_4'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            userId: 'user_5',
            name: 'Lucas Dubois',
            avatarUrl: AvatarHelper.getAvatarUrl('user_5'),
            permission: GroupPermission.member,
      ...
      GroupChatModel(
        ...
        photoUrl: 'assets/images/test2.png', // Utilise une image disponible
        members: [
          GroupMemberModel(
            userId: 'user_6',
            name: 'ProGamer42',
            avatarUrl: AvatarHelper.getAvatarUrl('user_6'),
            permission: GroupPermission.admin,
          ...
          GroupMemberModel(
            userId: 'user_7',
            name: 'NinjaKiller',
            avatarUrl: AvatarHelper.getAvatarUrl('user_7'),
            permission: GroupPermission.moderator,
          ...
          GroupMemberModel(
            userId: 'user_8',
            name: 'Emma Leroy',
            avatarUrl: AvatarHelper.getAvatarUrl('user_8'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            userId: 'user_9',
            name: 'MaxPower',
            avatarUrl: AvatarHelper.getAvatarUrl('user_9'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            userId: 'user_10',
            name: 'Léa Bernard',
            avatarUrl: AvatarHelper.getAvatarUrl('user_10'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            userId: 'user_11',
            name: 'Thomas Petit',
            avatarUrl: AvatarHelper.getAvatarUrl('user_11'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            userId: 'user_12',
            name: 'Camille Roux',
            avatarUrl: AvatarHelper.getAvatarUrl('user_12'),
            permission: GroupPermission.member,
            joinedAt: _now.subtract(const Duration(days: 90)),
          ),
          GroupMemberModel(
            userId: 'user_13',
            name: 'Hugo Moreau',
            avatarUrl: AvatarHelper.getAvatarUrl('user_13'),
            permission: GroupPermission.member,
            joinedAt: _now.subtract(const Duration(days: 85)),
          ),
        ],
      ...
      GroupChatModel(
        ...
        photoUrl: 'assets/images/Avatar1.png', // Utilise une image disponible
        members: [
          GroupMemberModel(
            userId: 'user_14',
            name: 'Papa Jean',
            avatarUrl: AvatarHelper.getAvatarUrl('user_14'),
            permission: GroupPermission.admin,
          ...
          GroupMemberModel(
            userId: 'user_15',
            name: 'Maman Marie',
            avatarUrl: AvatarHelper.getAvatarUrl('user_15'),
            permission: GroupPermission.admin,
            joinedAt: _now.subtract(const Duration(days: 365)),
          ),
          GroupMemberModel(
            userId: 'user_16',
            name: 'Julie',
            avatarUrl: AvatarHelper.getAvatarUrl('user_16'),
            permission: GroupPermission.member,
            joinedAt: _now.subtract(const Duration(days: 365)),
          ),
          GroupMemberModel(
            userId: 'user_17',
            name: 'Pierre',
            avatarUrl: AvatarHelper.getAvatarUrl('user_17'),
            permission: GroupPermission.member,
            joinedAt: _now.subtract(const Duration(days: 365)),
          ),
          GroupMemberModel(
            ...
            avatarUrl: AvatarHelper.getAvatarUrl('user_18'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            userId: 'user_19',
            name: 'Oncle Paul',
            avatarUrl: AvatarHelper.getAvatarUrl('user_19'),
            permission: GroupPermission.member,
      ...
      GroupChatModel(
        ...
        photoUrl: 'assets/images/Avatar2.png', // Utilise une image disponible
        members: [
          GroupMemberModel(
            userId: 'user_1',
            name: 'AlistairJr',
          ...
          GroupMemberModel(
            userId: 'user_20',
            name: 'Sarah Chen',
            avatarUrl: AvatarHelper.getAvatarUrl('user_20'),
            permission: GroupPermission.admin,
            joinedAt: _now.subtract(const Duration(days: 180)),
          ),
          GroupMemberModel(
            userId: 'user_21',
            name: 'Marc Lefebvre',
            avatarUrl: AvatarHelper.getAvatarUrl('user_21'),
            permission: GroupPermission.moderator,
          ...
          GroupMemberModel(
            userId: 'user_22',
            name: 'Nadia Benali',
            avatarUrl: AvatarHelper.getAvatarUrl('user_22'),
            permission: GroupPermission.moderator,
          ...
          GroupMemberModel(
            ...
            avatarUrl: AvatarHelper.getAvatarUrl('user_23'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            ...
            avatarUrl: AvatarHelper.getAvatarUrl('user_24'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            userId: 'user_25',
            name: 'Kevin Blanc',
            avatarUrl: AvatarHelper.getAvatarUrl('user_25'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            userId: 'user_26',
            name: 'Fatima Diallo',
            avatarUrl: AvatarHelper.getAvatarUrl('user_26'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            userId: 'user_27',
            name: 'Julien Mercier',
            avatarUrl: AvatarHelper.getAvatarUrl('user_27'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            ...
            avatarUrl: AvatarHelper.getAvatarUrl('user_28'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            userId: 'user_29',
            name: 'David Lambert',
            avatarUrl: AvatarHelper.getAvatarUrl('user_29'),
            permission: GroupPermission.member,
          ...
          GroupMemberModel(
            userId: 'user_30',
            name: 'Amélie Girard',
            avatarUrl: AvatarHelper.getAvatarUrl('user_30'),
            permission: GroupPermission.member,
